    ...
    if not args.skip_causal:
        ...
        try:
            ...
            if causal_data_dir:
                ...
                if causal_data:
                    # Perform individual causal analysis
                    ...
                    if causal_results:
                        ...
                        print("Individual causal Bayesian analysis completed successfully!")
                    else:
                        print("Individual causal Bayesian analysis failed.")

                    # Perform hierarchical causal analysis
                    print("\n" + "="*50)
                    print("Starting Hierarchical Causal Bayesian Analysis")
                    print("="*50)
                    try:
                        hierarchical_results = perform_hierarchical_causal_analysis(causal_data, args.output_dir, target_lipid)

                        if hierarchical_results:
                            completed_analyses.append("hierarchical_causal_analysis")
                            print("Hierarchical causal Bayesian analysis completed successfully!")
                        else:
                            print("Hierarchical causal Bayesian analysis failed.")
                    except Exception as hier_e:
                        print(f"Error in hierarchical causal analysis: {str(hier_e)}")
                        if args.verbose:
                            import traceback
                            traceback.print_exc()
                else:
