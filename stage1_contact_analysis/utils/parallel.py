...
def _frame_processor_worker(args):
    ...
    try:
        ...
        # Select proteins (import config for apply_residue_offset setting)
        from ..config import APPLY_RESIDUE_OFFSET
        proteins = select_proteins(universe, apply_residue_offset=APPLY_RESIDUE_OFFSET)
        ...
        residue_contacts = extract_residue_contacts(universe, frame_idx, proteins, close_pairs, leaflet0, apply_residue_offset=APPLY_RESIDUE_OFFSET)
