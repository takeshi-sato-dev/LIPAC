...
def extract_residue_contacts(universe, frame_idx, proteins, protein_pairs, leaflet0, apply_residue_offset=False):
    """Extract per-residue protein contacts and target lipid contacts
    ...
    for pair_name in protein_pairs:
        ...
        for res1 in protein1.residues:
            # Optionally convert residue ID
            actual_resid = res1.resid + RESIDUE_OFFSET if apply_residue_offset else res1.resid
            ...
            for res2 in protein2.residues:
                ...
                if min_dist <= 6.0:
                    ...
                    # Optionally convert partner protein's residue ID
                    partner_resid = res2.resid + RESIDUE_OFFSET if apply_residue_offset else res2.resid
        ...
        for res2 in protein2.residues:
            actual_resid = res2.resid + RESIDUE_OFFSET if apply_residue_offset else res2.resid
